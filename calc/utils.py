...
def create_prompt(model_data, change_request, proj_description):
    ...
    1. Phase 1: Define your task:
    Describe the task given (int short). Provide info about constraints you have.
    2. Phase 2: Identify impact:
    ...
    - List only the components in your analysis. List NO sub-systems or systems type. Definition: Component is the smallest functional or structural unit of a system. In could be internal and external.)
    """
